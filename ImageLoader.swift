...
public typealias CompletionHandlers = (NSURL, UIImage?, NSError?, CacheType) -> Void

class Block {

    let identifier: Int
    let completionHandler: CompletionHandlers
    init(identifier: Int, completionHandler: CompletionHandlers) {
