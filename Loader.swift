...
public class Loader {
    ...
    public func completionHandler(completionHandler: CompletionHandlers) -> Self {
        let identifier = (blocks.last?.identifier ?? 0) + 1
        return self.completionHandler(identifier, completionHandler: completionHandler)
    }

    public func completionHandler(identifier: Int, completionHandler: CompletionHandlers) -> Self {
