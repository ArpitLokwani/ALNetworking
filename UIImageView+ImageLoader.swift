...
extension UIImageView {
    ...
    // MARK: - functions
    public func load(URL: URLLiteralConvertible, placeholder: UIImage? = nil, completionHandler:CompletionHandlers? = nil) {
    ...
    private func imageLoader_load(URL: NSURL, completionHandler: CompletionHandlers?) {
        let handler: CompletionHandlers = { [weak self] URL, image, error, cacheType in
